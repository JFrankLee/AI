...
def parse_args(src_image_dir, save_dir):
    # parser = argparse.ArgumentParser(description='Model prediction')

    # # params of prediction
    # parser.add_argument(
    #     "--config", dest="cfg", help="The config file.", default='configs/pp_liteseg/pp_liteseg_stdc1_camvid_960x720_10k_my.yml', type=str)
    ...
    #     type=str)
    args = dict(
        cfg = 'configs/segformer/segformer_b3_cityscapes_1024x512_160k my.yml',
        model_path='model.pdparams',
        image_path=src_image_dir,
        save_dir=save_dir,
        aug_pred=False,
        scales=1.0,
...
def mai(src_image_dir, save_dir):
    args = parse_args(src_image_dir, save_dir)
    m(args)
